...
return [
    ...
    'root_namespace'         => [],
    // 扩展函数文件
    'extra_file_list'        => [THINK_PATH.'helper'.EXT, EXTEND_PATH.'filter'.EXT],
    // 默认输出类型
    ...
    'log'                    => [
        ...
        'path'  => LOG_PATH,
        // 日志记录级别
        'level' => [Log::LOG, Log::ERROR, /* Log::INFO, */ Log::SQL, Log::NOTICE, Log::ALERT, Log::DEBUG],
        // 日志时间戳格式
    ...
    'session'                => [
        ...
        'prefix'         => '',     // SESSION 前缀
        'type'           => '',     // 'db',   // 驱动方式 支持redis memcache memcached
    ...
    'auth'                => [  // RBAC配置
      'enable'            => true,
      'session_name'      => 'CMS_USER_AUTH_KEY',// C('auth.session_name')
    ],
    ...
    'database'         => [
      ...
      'dsn'            => '',
      // 服务器地址
      'hostname'       => '116.62.160.205',
      // 数据库名
      'database'       => '',
      // 数据库用户名
      'username'       => 'owen',
      // 数据库密码
      'password'       => 'd@HAyz3#4aPv7%W0',
      // 数据库连接端口
      'hostport'       => 3306,
      // 数据库连接参数
      'params'         => [
